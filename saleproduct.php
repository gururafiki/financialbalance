  ...
  if($_SESSION['level']=='SAD38742987aS679as' || $_SESSION['level']=='2138197fcbcsad987s'){
    ...
    foreach ($users as $user) {
      ...
      foreach ($stocks as $stock) {
        if($stock['stock']==$user['name'] || $stock['stock']==$username)
          $buf=false;
      }
      if($buf){
        $allstocks[]=$user['name'];
...
<html lang="en">
  <head>
    ...
    <title>Продажа товара | <?=$username?> </title>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left"  action="functions.php" method="post">
                      <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-2">
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stockname">Кто дал товар (выберете свое имя,если товар не числиться за складом)
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group">
                            <label for="secondpersons" class="control-label col-md-3 col-sm-3 col-xs-12">Фирма покупатель (имя - если покупатель частное лицо)<span class="required">*</span></label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
