<?php
  ...
  if($_SESSION['level']=='SAD38742987aS679as'){
      $table = R::getAll( 'SELECT * FROM `gururafiki_financetotalcontrol`.`products` ORDER BY `id` ASC, `totalprice` ASC LIMIT 1000;');
  }
...
<html lang="en">
  <head>
    ...
    <title>О продуктах | <?=$username?></title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Отчет по продукции <small>Просмотр списка продукции</small></h3>
              </div>
            </div>
            ...
            <div class="row">      
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>За всё время<small>Все продукты</small></h2>
