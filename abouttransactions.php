<?php
  ...
  if($_SESSION['level']=='SAD38742987aS679as'){
      $table = R::getAll( 'SELECT * FROM `gururafiki_financetotalcontrol`.`transactions` ORDER BY `id` ASC, `total` ASC LIMIT 1000;');
  }
...
<html lang="en">
  <head>
    ...
    <title>Все транзакции | <?=$username?></title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Все транзакции <small>Просмотр списка транзакций и приметок</small></h3>
              </div>
            </div>
            ...
            <div class="row">      
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Сентябрь<small>Все транзакции</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Все транзакции за сентябрь 2017.
                    </p>
