<?php
  ...
  if($_SESSION['level']=='SAD38742987aS679as' || $_SESSION['level']=='2138197fcbcsad987s'){
    $username=$_SESSION['name'];
    $products=R::getAll( 'SELECT * FROM `gururafiki_financetotalcontrol`.`products` GROUP BY `id` ASC, `totalprice` ASC LIMIT 1000;');
...
<html lang="en">
  <head>
    ...
    <title>Денежный перевод  | <?=$username?> </title>
                      ...
                      <div id="wizard" class="form_wizard wizard_horizontal">
                          ...
                          <li>
                            <a href="#step-1">
                              ...
                              <span class="step_descr">
                                                Шаг 1<br />
                                                <small>Выберите тип транзакции</small>
                                            </span>
                            </a>
                          </li>
                          <li>
                        ...
                        <div id="step-1">
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Выбор типа</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <div id="type" class="btn-group" data-toggle="buttons">
                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                  <input type="radio" name="type" value="take"> Я получил деньги
                                </label>
                                <label class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                  <input type="radio" name="type" value="give"> Я отдал деньги
                                </label>
                              </div>
                            </div>
                          </div>
                        ...
                        <div id="step-2">
                          ...
                          <div class="form-group">
                            <label for="secondpersons" class="control-label col-md-3 col-sm-3 col-xs-12">С кем произведен расчет(кто дал/взял деньги)</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
